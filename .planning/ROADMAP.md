...
- [ ] **Phase 59: Dashboard Cleanup + Dependency Removal** — Remove widget system, Workload route, and react-grid-layout package atomically
...
| 59. Dashboard Cleanup + Dependency Removal | v1.9 | 2/3 | In Progress|  |
