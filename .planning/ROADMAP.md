...
- [x] 67-01-PLAN.md — strip dnd-kit from SidebarItemsList (visibility-only checkbox list), remove reorderSidebarItem store action, update both test files, uninstall 4 @dnd-kit packages (SETUI-01, SETUI-02, SETUI-03)
...
- [x] 68-01-PLAN.md — bump onboarding store step limit + integrationsVisited flag, extract AioBlock (UI-SPEC gap-2/font-normal corrections), update IntegrationsSection to import it (WIZ-01, WIZ-02)

**Wave 2** *(blocked on Wave 1)*

- [x] 68-02-PLAN.md — IntegrationsStep component: AioBlock + inline Tempo toggle + gated Back/Continue, direct settings-store binding (WIZ-02, WIZ-03, WIZ-04)

**Wave 3** *(blocked on Wave 2)*

- [x] 68-03-PLAN.md — wire IntegrationsStep into OnboardingWizard at index 3, full build + suite verification, human-verify checkpoint (WIZ-01)
