...
- [ ] **Phase 60: Static Dashboard / Welcome Screen** — Replace widget grid with a minimal 3-card static layout using existing query cache (3/4 plans complete)
...
| 60. Static Dashboard / Welcome Screen | v1.9 | 3/4 | In Progress | - |
