...
- [ ] **Phase 5: API Foundation + Quick Wins** - Extend Jira types and fetch strategy; fix GitLab open-only filter; ship Releases display improvements
...
| 5. API Foundation + Quick Wins | 1/4 | In Progress|  | - |
