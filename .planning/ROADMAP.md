...
Plans:
- [ ] 86-01-PLAN.md — MyIssuesCard + UpcomingReleasesTimeline (top-row cards, D-02..D-08) [wave 1]
- [ ] 86-02-PLAN.md — HoursCommitsChart dual-axis rolling-7 chart (D-09..D-12, D-14) [wave 1]
- [ ] 86-03-PLAN.md — Rewrite index.tsx (3-region + sprint-day subline) + delete old widgets/helpers + extend removal guard (D-01, D-13) [wave 2]
