...
- 🚧 **v1.5 Dashboard Redesign & Feature Parity** — Phases 31-37 (in progress)
...
- [x] 32-05-PLAN.md — Gap closure: restore destroyed type exports in jira/types.ts
**UI hint**: yes
...
- [x] 33-03-PLAN.md — Bulk operations: card checkboxes, floating action bar, progress indicator
- [x] 33-04-PLAN.md — Saved filter dialogs (save/edit) + SavedFilterList + UnifiedFilterBar integration
- [x] 33-05-PLAN.md — Sidebar + command palette integration + visual verification checkpoint
**UI hint**: yes
...
- [x] 34-04-PLAN.md — Remaining 8 compact widget implementations + Custom JQL
...
### Phase 37: Wire Saved Filters to Sprint Board
**Goal**: Re-add saved filter consumption in SprintBoardTab so clicking a saved filter actually constrains the board view
**Depends on**: Phase 36
**Requirements**: FILT-02, FILT-04
**Gap Closure:** Closes integration gap from v1.5 audit (activeFilterId set but never consumed by SprintBoardTab)
**Success Criteria** (what must be TRUE):
...
| 37. Wire Saved Filters to Sprint Board | v1.5 | 0/0 | Pending | — |
