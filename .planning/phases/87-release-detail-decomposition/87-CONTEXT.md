...
- **D-14:** Safety net = **unit tests on the extracted pure functions + typecheck + manual UAT**. No full-page characterization test in this phase.
  ...
  - Page-level correctness is verified by `npm run check` (biome + tsc, baseline is GREEN — keep it GREEN) plus a manual click-through of the release detail page.
