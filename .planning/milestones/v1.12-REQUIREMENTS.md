# Requirements Archive: v1.12 Jira Experience Improvements
...
- [x] **PEEK-01**: Clicking an issue anywhere in the app (board, backlog, standup, dashboard, search) — except on its issue key — opens a slideover preview of that issue. (Notifications and recent-items deliberately navigate to the full issue page instead of opening the peek — decision 260605-hb4.)
