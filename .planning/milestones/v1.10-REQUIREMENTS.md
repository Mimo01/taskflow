# Requirements Archive: v1.10 Cleanup, Roles Removal & Standup Notes
...
- [x] **WIZ-01**: New "Integrations" step in wizard, between Connections and Done
- [x] **WIZ-02**: Integrations step exposes AIO toggle; when on, shows project picker (same picker as Settings → Integrations)
- [x] **WIZ-03**: Integrations step exposes Tempo toggle
- [x] **WIZ-04**: Wizard completion writes Integrations selections into Settings store (single source of truth — no separate wizard state)

### Standup Notes

- [x] **STAND-01**: New `/standup-notes` route + sidebar entry "Standup Notes" (visible to everyone post-roles-removal)
- [x] **STAND-02**: "Yesterday" = last working day — Monday shows Friday's data; weekends skipped; public holidays from Tempo schedule API skipped when Tempo is enabled
- [x] **STAND-03**: Yesterday recap shows my Tempo worklogs (issue key, duration, comment) — empty section when Tempo disabled
- [x] **STAND-04**: Yesterday recap shows Jira changelog activity I authored — status transitions + comments
- [x] **STAND-05**: Yesterday recap shows Git commits I authored on the configured GitLab project (commit message + SHA + linked Jira key when parseable from message)
- [x] **STAND-06**: Yesterday recap shows MR activity I performed — comments I posted + approvals I gave
...
- [-] **STAND-09**: ~~Today section shows planned worklog targets — issues I plan to log time against today (pre-fills Tempo entries)~~ — DESCOPED (won't-do): delivered in Phase 70 then removed during the Phase 70 standup redesign (commit c5b19544); Log Work action dropped from the Today column by user decision (70-UAT.md test #4)
...
| WIZ-01 | Phase 68 | Complete |
| WIZ-02 | Phase 68 | Complete |
| WIZ-03 | Phase 68 | Complete |
| WIZ-04 | Phase 68 | Complete |
| STAND-01 | Phase 69 | Complete |
| STAND-02 | Phase 69 | Complete |
| STAND-03 | Phase 69 | Complete |
| STAND-04 | Phase 69 | Complete |
| STAND-05 | Phase 69 | Complete |
| STAND-06 | Phase 69 | Complete |
| STAND-07 | Phase 70 | Complete |
| STAND-08 | Phase 70 | Descoped (pinned removed by user) |
| STAND-09 | Phase 70 | Descoped (Log Work removed in redesign) |

**Coverage:**
- v1.10 requirements: 29 total
- Mapped to phases: 29
- Unmapped: 0 ✓
- Complete: 27 · Descoped: 2 (STAND-08 pinned, STAND-09 Log Work)

---
*Requirements defined: 2026-05-23*
*Last updated: 2026-05-25 — milestone audit: WIZ-01..04 + STAND-01..06 marked Complete; STAND-09 reclassified Descoped*
