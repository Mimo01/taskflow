...
Plan: —
Status: Awaiting next milestone
Last activity: 2026-08-27 - Completed quick task 260827-eaj: Add a settings option to open links in a user-selectable browser (covers 'open in browser' links and links inside descriptions/comments)
...
| 260827-eaj | Add a settings option to open links in a user-selectable browser (covers 'open in browser' links and links inside descriptions/comments) | 2026-08-27 | f363a25c | Needs Review | [260827-eaj-add-a-settings-option-to-open-links-in-a](./quick/260827-eaj-add-a-settings-option-to-open-links-in-a/) |
