...
Plan: —
Status: Awaiting next milestone
Last activity: 2026-08-27 - Verified quick task 260827-gji: Fix My Tasks MR review badges to compute real review state via deriveReviewHealth() — live user confirmation received
