...
Last activity: 2026-06-06 - Completed quick task 260606-o5y: sprint board story rows open the issue peek preview like cards (PEEK-01/05 split ported into StoryHeaderRow, all 3 sites wired, Biome GREEN)
...
| 260606-o5y | Sprint board: story swimlane rows open the issue peek preview like cards (PEEK-01 body→peek, PEEK-05 key→full-page); all 3 sites wired | 2026-06-06 | 0ec11e41 | Needs Review (runtime UI smoke) | [260606-o5y-on-sprint-board-story-rows-open-issue-pr](./quick/260606-o5y-on-sprint-board-story-rows-open-issue-pr/) |
