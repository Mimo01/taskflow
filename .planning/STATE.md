...
Plan: —
Status: Awaiting next milestone
Last activity: 2026-08-27 - Verified quick task 260827-eaj: Add a settings option to open links in a user-selectable browser (covers 'open in browser' links and links inside descriptions/comments), including a live-testing follow-up fix for the settings trigger label
