...
- [ ] **DETAIL-07**: User can download issue attachments
- [ ] **DETAIL-08**: User can upload file attachments to issues
...
- [ ] **TIME-01**: User can log time spent on an issue with natural language input ("2h 30m")
- [ ] **TIME-02**: User can view worklogs on issue detail (author, time spent, date, comment)
- [ ] **TIME-03**: User can edit own worklog entries
- [ ] **TIME-04**: User can delete own worklog entries
...
| DETAIL-07 | Phase 32 | Pending |
| DETAIL-08 | Phase 32 | Pending |
